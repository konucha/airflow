...
# connect mongodb to bigquery using composer airflow in GCP
# URI = mongodb+srv://stagemedtrackuser:P8pplYd5LqEWurgW@medtrack-staging-pri.f6aki.mongodb.net/?retryWrites=true&w=majority
# db = tnt
# collections = receptions

    
def mongo_to_bigquery():
    # Menghubungkan ke MongoDB
    client = MongoClient('mongodb+srv://stagemedtrackuser:P8pplYd5LqEWurgW@medtrack-staging-pri.f6aki.mongodb.net/?retryWrites=true&w=majority')
    db = tnt
